        ...
        <nav className="bg-gray-800 p-4">
            <div className="container mx-auto flex justify-between items-center">
                <div className="flex items-center space-x-4">
                    <a href="/" className="text-white text-lg font-bold">SFKanban</a>
                    <a href="/workspaces" className="text-gray-300 hover:text-white">Workspaces</a>
                </div>
                <div>
                    {token ? (
                        <>
                            <a href="/login" onClick={() => localStorage.removeItem('token')} className="text-gray-300 hover:text-white mr-4">Sign out</a>
                        </>
                    ) : (
                        <>
